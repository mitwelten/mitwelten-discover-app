...
EXCLUDED_DEPLOYMENTS = ["Access Point"]
...
DISCOVER_DESCRIPTION = "The project develops environmental media tools to foster biodiversity in (peri-)urban areas by extending design research to natural and cultural sciences. In three field study sites of human-environment entanglements, media infrastructures were installed: in the Merian Gardens near Basel, in a former port area of the city of Basel, and in a nature reserve in Reinach (Basel agglomeration). The represented data is collected directly from the scientific database."
